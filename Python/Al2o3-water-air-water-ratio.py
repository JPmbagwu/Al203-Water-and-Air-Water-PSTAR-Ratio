...
# -*- coding: utf-8 -*-
"""
Created on Tue May 21 11:15:44 2024
...
if normalization_index_water.size == 0 or normalization_index_al2o3.size == 0 or normalization_index_air.size == 0:
...
# Calculate the Al2O3-to-Water and Air-to-Water stopping power ratios
stopping_power_ratio_al2o3 = interpolated_stopping_power_al2o3 / normalized_stopping_power_water
stopping_power_ratio_air = interpolated_stopping_power_air / normalized_stopping_power_water

# Plotting
plt.figure(figsize=(10, 6))

# Plotting the Al2O3-to-Water stopping power ratio
plt.plot(energy_water, stopping_power_ratio_al2o3, label='Al2O3-to-Water Stopping Power Ratio')

# Plotting the Air-to-Water stopping power ratio
plt.plot(energy_water, stopping_power_ratio_air, label='Air-to-Water Stopping Power Ratio')

plt.title('Stopping Power Ratios')
...
plt.ylim(0, max(max(stopping_power_ratio_al2o3), max(stopping_power_ratio_air)) * 1.1)
